...
app = application
PAT = 'EAADsV0hoNg4BABHmLmZBDyijibZBpb7JfzkqNf8ArnbXezVdhVIS6ZBTedlYl9nSqMtNSjskenPb6kaOtaM03N24UXGxFrPNuS5P9ZANlt4nEPhoyCrdQbdpsgZCywFXyTeJ5sHZCM12In9sFZCoG7QBq3Y20jLOQXS4Wzy4iQc1AZDZD'
@app.route('/', methods=['GET'])
def handle_verification():
    print "Handling Verification."
    if request.args.get('hub.verify_token', '') == 'token_joanne':
    ...
    for event in messaging_events:
        ...
        # Message with attachment (location, audio, photo, file, etc)
            ...
            # Audio
                ...
                yield sender_id, {'type':'text','data':"Sorry, I don't understand this.", 'message_id': event['message']['mid']}
